      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        {cards.map((cd, i) => (
          <div key={cd.title} ref={(el) => { c.current[i] = el; }} className="group bg-shadow p-8 md:p-10 flex flex-col opacity-0 hover:bg-shadow/80 transition-all duration-500 border border-white/5 hover:border-olive/20">
            ...
            <button className="self-start text-[10px] font-medium tracking-[0.15em] text-olive border-b border-olive/50 pb-1 hover:border-olive transition-colors duration-500">{cd.cta}</button>
          </div>
        ))}
      </div>
    </section>
...
function QuizSection() {
  ...
  return (
    <section ref={s} className="w-full bg-shadow py-[80px] md:py-[120px] px-6 md:px-16">
      <div ref={c} className="max-w-[700px] mx-auto opacity-0">
        {step === 0 && (
          <div className="text-center">
            ...
            <p className="text-[13px] md:text-[14px] font-light leading-[1.8] text-white/60 mt-6">5 questions. 3 minutes.<br />A bespoke recommendation from our team.</p>
        ...
        {step > questions.length && (
          <div className="text-center">
            ...
            <form className="flex flex-col sm:flex-row items-center gap-4 max-w-[500px] mx-auto" onSubmit={(e) => e.preventDefault()}>
              <input type="text" placeholder="Name" className="flex-grow w-full sm:w-auto bg-transparent border-b border-white/20 pb-2 text-[12px] tracking-[0.05em] text-white placeholder:text-white/30 focus:outline-none focus:border-olive transition-colors duration-500" />
              <input type="email" placeholder="Email" className="flex-grow w-full sm:w-auto bg-transparent border-b border-white/20 pb-2 text-[12px] tracking-[0.05em] text-white placeholder:text-white/30 focus:outline-none focus:border-olive transition-colors duration-500" />
...
function NewsletterSection() {
  ...
  return (
    <section ref={s} className="w-full bg-carbon py-[120px] md:py-[200px] px-6 md:px-16">
      <div ref={c} className="max-w-[600px] mx-auto text-center opacity-0">
        ...
        <form className="mt-12 flex flex-col sm:flex-row items-center gap-4" onSubmit={(e) => e.preventDefault()}>
